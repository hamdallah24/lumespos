          ...
          {isLoadingProducts ? (
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 md:gap-3">
              {products.map((product: Product, idx: number) => (
                ...
                >
                  <div className="aspect-square bg-muted flex items-center justify-center overflow-hidden p-3">
                    {product.imageUrl ? (
                      <img src={product.imageUrl.startsWith("http") ? product.imageUrl : `/api/storage${product.imageUrl}`} alt={product.name} className="w-full h-full object-contain" />
                    ) : (
