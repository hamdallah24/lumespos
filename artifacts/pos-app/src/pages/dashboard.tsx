...
export default function DashboardPage() {
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="h-[52px] border-b border-slate-100 dark:border-slate-800 px-4 lg:px-6 flex items-center gap-2 bg-white dark:bg-[#0F1D32] shrink-0 sticky top-0 z-20 ">
