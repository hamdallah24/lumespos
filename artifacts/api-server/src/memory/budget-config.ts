...
export const MODEL_DENSITY: Record<string, ModelDensity> = {
  ...
  "gpt-4-turbo":         { name: "gpt-4-turbo",         density: 1.0, maxOutput: 4096,  maxContext: 128000,  responseTime: 500 },
  "claude-3-opus":       { name: "claude-3-opus",       density: 1.2, maxOutput: 4096,  maxContext: 200000,  responseTime: 700 },
  "claude-3-sonnet":     { name: "claude-3-sonnet",     density: 1.15, maxOutput: 4096, maxContext: 200000,  responseTime: 500 },
  "claude-3-haiku":      { name: "claude-3-haiku",      density: 1.1, maxOutput: 4096,  maxContext: 200000,  responseTime: 300 },
  "gemini-2.5-flash":    { name: "gemini-2.5-flash",    density: 0.95, maxOutput: 8192, maxContext: 1048576, responseTime: 400 },
  "gemini-2.5-pro":      { name: "gemini-2.5-pro",      density: 1.0, maxOutput: 8192,  maxContext: 1048576, responseTime: 600 },
};
...
export function getModelContext(modelName?: string): number {
