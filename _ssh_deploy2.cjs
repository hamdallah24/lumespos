...
conn.on('ready', () => {
  const cmd = 'cd /home/ubuntu/lumespos && git pull --rebase 2>&1 && pnpm install 2>&1 && pnpm --filter ./artifacts/pos-app run build 2>&1 && pm2 restart lumes-pos-app 2>&1 && echo "=== DONE ==="';
